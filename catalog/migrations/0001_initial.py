# Generated by Django 3.0.6 on 2020-05-31 08:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('m', 'Maintenance'), ('o', 'On loan'), ('a', 'Available'), ('r', 'Reveresed')], default='m', help_text='Book availability', max_length=1)),
